var app = {
    ...
    showGeneric: function (id, text, value, size) {
        var formatted = app.formatDecimal(value, size - (text.length - 7));
        if (formatted) {
    ...
    showDiffMiliSeconds: function (date) {
        ...
        app.showGeneric("miliseconds", "Milisegundos: ", diff, 8);
    },
    showDiffSeconds: function (date) {
        ...
        app.showGeneric("seconds", "Segundos: ", diff, 12);
    },
    showDiffMinutes: function (date) {
        ...
        app.showGeneric("minutes", "Mininutos: ", diff, 11);
    },
    showDiffHours: function (date) {
        ...
        app.showGeneric("hours", "Horas: ", diff, 15);
    },
    showDiffDays: function (date) {
        ...
        app.showGeneric("days", "Dias: ", diff, 16);
    },
    showDiffWeeks: function (date) {
        ...
        app.showGeneric("weeks", "Semanas: ", diff, 13);
    },
    showDiffMonths: function (date) {
        ...
        app.showGeneric("months", "Meses: ", diff, 15);
    },
    showDiffYears: function (date) {
        ...
        app.showGeneric("years", "Anos: ", diff, 16);
    },
